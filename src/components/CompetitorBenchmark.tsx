    ...
    <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 shadow-sm">
      ...
      <div className="mt-8 bg-black/80 rounded-xl p-8 text-white border-2 border-green-500">
        ...
        <p className="text-gray-300">
          This isn't luck—it's your competitive moat. Use these numbers when pitching brands.
        </p>
      </div>

      <div className="mt-6 text-xs text-gray-400 text-center">
        Data source: JABA PlayFlyFull_roster_teams.json (20 schools, 177+ teams) | Industry benchmarks: NCAA NIL Collective averages
      </div>
    </div>
  );
}
